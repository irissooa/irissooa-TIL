...
> **주아언니가 가르쳐줌**
>
> 숫자가 붙어서 input이 주어지는 것을 list로 변환하려면
>
> `list(map(int,input()))`으로 받으면 됨!!!!
...
- 위코드 b와 c의 순서를 바꿨더니 됐다!...ㅠ 왜지?

> q에 append되는 순서가 달라서 그런가???
...
> `dist[N] = 1`시작점을 방문처리하고, 마지막 return값에 시작할때의 1을 빼면 답이 나옴!
>
> => 시작지점을 방문처리안해서 오답이 떴던 것 같음!!!
